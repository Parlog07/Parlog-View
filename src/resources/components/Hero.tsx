    ...
    <div className="relative w-full h-[80vh] text-white">
      ...
      <div className="absolute top-1/4 left-4 md:left-12 max-w-2xl px-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="flex items-center gap-2 px-6 py-3 bg-gray-500/50 hover:bg-gray-500/70 text-white font-semibold rounded-full transition-colors backdrop-blur-sm">
            <Info size={20} />
            More Info
          </button>
        </div>
